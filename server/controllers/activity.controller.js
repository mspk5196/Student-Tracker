...
/**
 * GET /api/activity/heatmap/:studentId?year=2024
 * Admin endpoint to fetch activity heatmap for a specific student
 * Returns: [{ date: 'YYYY-MM-DD', activity_level: 0-4, activities: string[] }]
 */
export const getStudentActivityHeatmapByStudentId = async (req, res) => {
  try {
    ...
    console.error('Error fetching student activity heatmap:', error);
    res.status(500).json({
      success: false,
      message: 'Failed to fetch heatmap activity',
      error: error.message,
