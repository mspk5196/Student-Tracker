                                ...
                                <tr key={student.id}>
                                    ...
                                    <td>
                                        {student.link ? (
                                            <a 
                                                ...
                                                rel="noopener noreferrer"
                                            >
                                                <LinkIcon sx={{ fontSize: 18 }} /> View Link
                                            </a>
                                        ) : (
                                            <span className="no-submission">—</span>
                                        )}
                                    ...
                                    <td>
                                        <div className={`status-tag ${
                                            !student.hasSubmitted ? 'tag-not-submitted' :
                                            student.status === 'Graded' ? 'tag-graded' : 
                                            student.status === 'Needs Revision' ? 'tag-revision' : 'tag-pending'
                                        }`}>
                                            {!student.hasSubmitted ? 'Not Submitted' : student.status}
                                        </div>
                                    </td>
                                    <td>
                                        <div className="mark-pill">
                                            <input
                                                ...
                                                placeholder="--"
                                                disabled={!student.hasSubmitted || (student.status === 'Graded' && student.action === 'Edit')}
                                            />
