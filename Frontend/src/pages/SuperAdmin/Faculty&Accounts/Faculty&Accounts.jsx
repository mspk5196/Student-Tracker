...
const FacultyAccounts = () => {
    ...
    const openEditModal = (faculty) => {
        ...
        setEditFormData({
            ...
            facultyId: `FAC-${faculty.id. toString().padStart(3, '0')}`,
            email: faculty.email,
    ...
    const closeEditModal = () => {
        ...
        setEditFormData({ name: '', designation: '', facultyId: '', email: '', department: '', status:  '', profilePic: null });
    };
        ...
        <div style={styles.container}>
            ...
            {isEditModalOpen && selectedFaculty && (
                <div style={styles.modalOverlay} onClick={closeEditModal}>
                    <div style={styles. modalContent} onClick={(e) => e.stopPropagation()}>
                        <div style={styles.modalHeader}>
                            <h2 style={styles. modalTitle}>Edit Faculty Details</h2>
                        ...
                        <div style={styles. form}>
                            ...
                            <div style={styles.formGroup}>
                                ...
                                <div style={styles.uploadArea}>
                                    <input
                                        ...
                                        id="edit-profile-pic"
                                    />
                                    <label htmlFor="edit-profile-pic" style={styles.uploadLabel}>
                                        <CloudUpload sx={{ fontSize: 32, color: '#94a3b8', marginBottom: '8px' }} />
                                        <span style={styles.uploadText}>
                                            {editFormData.profilePic ? editFormData.profilePic.name : 'Click to upload or drag and drop'}
                                        </span>
                                        <span style={styles. uploadSubtext}>PNG, JPG or JPEG (max. 5MB)</span>
                                    </label>
                                </div>
                            ...
                            <div style={styles. modalFooter}>
                                ...
                                <button type="button" style={styles.submitBtn} onClick={handleEditSubmit}>
                                    Update Faculty
                                </button>
                            </div>
                        </div>
