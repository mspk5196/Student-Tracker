...
const styles = {
    ...
    tabActive: { padding: '6px 14px', border: 'none', borderRadius: '6px', backgroundColor: '#FFFFFF', fontSize: '13px', fontWeight: '500', color: '#374151', cursor: 'pointer', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' },
    tabInactive: { padding: '6px 14px', border: 'none', backgroundColor: 'transparent', fontSize: '13px', fontWeight: '500', color: '#6B7280', cursor: 'pointer' },
    dropdown: { display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 14px', backgroundColor: '#FFFFFF', border: '1px solid #E5E7EB', borderRadius: '8px', fontSize: '13px', color: '#374151' },
    headerRight: { display: 'flex', gap: '12px' },
    studentViewBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 14px', backgroundColor: '#FFFFFF', border: '1px solid #E5E7EB', borderRadius: '8px', fontSize: '13px', fontWeight: '600', cursor: 'pointer' },
    addDayBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 14px', backgroundColor: '#0066FF', border: 'none', borderRadius: '8px', fontSize: '13px', fontWeight: '600', color: '#FFFFFF', cursor: 'pointer' },
