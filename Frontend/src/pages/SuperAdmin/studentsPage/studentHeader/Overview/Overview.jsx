...
const Overview = ({ studentId }) => {
  ...
  // ✅ ALL useMemo CALLS BEFORE ANY CONDITIONAL RETURNS
  const circ = 377;
            ...
            <div style={{ ... styles.card, flex: 1, textAlign: 'center' }}>
              ...
              <div style={styles. donutWrapper}>
                <svg width="140" height="140" viewBox="0 0 150 150">
                  ...
                  <circle
                    ...
                    style={{ transition: 'stroke-dasharray 1.5s ease-out 0.3s' }}
                  />
                  <text x="75" y="72" textAnchor="middle" fontSize="32" fontWeight="900" fill="#1e293b">
                    {countTotal}
                  </text>
                  <text x="75" y="92" textAnchor="middle" fontSize="10" fontWeight="800" fill="#94a3b8">
                    TASKS
                  </text>
                </svg>
              </div>
              <div style={styles.legend}>
                <div style={styles.legendItem}>
                  <div style={{ ...styles.dot, backgroundColor: '#2563eb' }} /> <span>Done</span>
                </div>
                <div style={styles. legendItem}>
                  <div style={{ ...styles.dot, backgroundColor: '#93c5fd' }} /> <span>Progress</span>
                </div>
              </div>
            </div>
          </div>
              ...
              {studentData.performance.map((perf, index) => (
                ...
                >
                  ...
                  <div
                    style={{
                      ... styles.barFrame,
                      backgroundColor: hoveredPerf?.subject === perf.subject ? '#eff6ff' : '#fcfdfe',
                    }}
                  >
                    <div
                      style={{
                  ...
                  <p
                    style={{
                      ... styles.subjectText,
                      color: hoveredPerf?.subject === perf.subject ? '#2563eb' : '#475569',
                    }}
                  >
                    {perf.subject}
                  </p>
